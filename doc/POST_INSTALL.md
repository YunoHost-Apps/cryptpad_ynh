We have added a sandbox domain: __DOMAIN_SANDBOX__ for you but you still need to configure your DNS and regenerate the Let's Encrypt Certificates for the main domain.
